...
export const TestPage: React.FC<TestPageProps> = ({ id, questions, timer, title }) => {
  ...
  const [checkboxValue, setCheckboxValue] = useLocalStorage('checkboxValue', {});
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setQuestionNumberStorage(questionNumberStorage + 1)
  }
  ...
  return (
    <>
      ...
      <>
        ...
        {currentQuestion && questionNumberStorage !== questions.length ?
